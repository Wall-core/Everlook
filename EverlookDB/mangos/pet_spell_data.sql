...
-- Dumping data for table mangos.pet_spell_data: ~379 rows (approximately)
REPLACE INTO `pet_spell_data` (`entry`, `build`, `spell_id1`, `spell_id2`, `spell_id3`, `spell_id4`) VALUES

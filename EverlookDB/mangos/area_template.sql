...
CREATE TABLE IF NOT EXISTS `area_template` (
  ...
  `area_level` mediumint(8) NOT NULL DEFAULT 0,
...
-- Dumping data for table mangos.area_template: 1,083 rows
...
REPLACE INTO `area_template` (`entry`, `map_id`, `zone_id`, `explore_flag`, `flags`, `area_level`, `name`, `team`, `liquid_type`) VALUES
	...
	(2366, 269, 0, 896, 64, 0, 'The Black Morass', 0, 0),
	(2367, 269, 0, 897, 64, 0, 'Old Hillsbrad Foothills', 0, 0),
	(2368, 269, 2367, 898, 64, 0, 'Tarren Mill', 0, 0),
	(2369, 269, 2367, 899, 64, 0, 'Southshore', 0, 0),
	(2370, 269, 2367, 900, 64, 0, 'Durnholde Keep', 0, 0),
	(2371, 269, 2367, 901, 64, 0, 'Dun Garok', 0, 0),
	(2372, 269, 2367, 902, 64, 0, 'Hillsbrad Fields', 0, 0),
	(2373, 269, 2367, 903, 64, 0, 'Eastern Strand', 0, 0),
	(2374, 269, 2367, 904, 64, 0, 'Nethander Stead', 0, 0),
	(2375, 269, 2367, 905, 64, 0, 'Darrow Hill', 0, 0),
	(2376, 269, 2367, 906, 64, 0, 'Southpoint Tower', 0, 0),
	(2377, 269, 2367, 907, 64, 0, 'Thoradin\'s Wall', 0, 0),
	(2378, 269, 2367, 908, 64, 0, 'Western Strand', 0, 0),
	(2379, 269, 2367, 909, 64, 0, 'Azurelode Mine', 0, 0),
	...
	(3457, 532, 0, 2001, 0, 0, 'Karazhan', 0, 0),
	(4001, 605, 0, 2001, 0, 0, 'Development Land', 0, 0);

...
-- Dumping data for table mangos.game_tele: 345 rows
...
REPLACE INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(513, 1437.69, 2004.53, 1.4481, 1.69514, 269, 'ohb6'),
	(514, 1330.05, 2163.5, 102.965, 2.17423, 269, 'ohb7'),
	(515, 675.704, 25.6896, -50.6199, 3.3398, 230, 'angerforge'),
	(516, 1323.51, 2182.1, 138.06, 3.98458, 269, 'ohb8');
